...
/*   Updated: 2025/04/12 23:20:02 by fde-alen         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
private:
	...
	Bot* _bot;
	bool cmdAddBotCheckArgs(const std::vector<std::string>& args);
	bool cmdAddBotCheck(const std::vector<std::string>& args, int clientFd);
	void cmdAddBot(const std::vector<std::string>& args, int clientFd);
